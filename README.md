...
- Host-only channel board on `localhost` for quickly reopening existing channels
...
- The all-channel board is only served to loopback requests from the host machine.
