...
Dead simple local-network sync for text, images, videos, and DMG files.
...
4. Type text or add/drag images, videos, or DMG files.
5. Click an image/video to preview it, click a DMG to download it, or hover over an asset to download/remove it.
...
The smoke test covers passcode validation, text sync, image upload, video upload, DMG upload, WebSocket broadcast, and restart persistence.
